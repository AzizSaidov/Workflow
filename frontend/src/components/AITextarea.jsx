    ...
    try {
      ...
      if (action === 'generate' && aiContext?.mode === 'bid') {
        ...
        const { data } = await aiApi.chat(
          `Исправь грамматику и стиль текста. Сохрани точный смысл, все числа, сроки, факты и намерение автора без изменений — только исправь ошибки и сделай текст грамотнее. Верни только исправленный текст без комментариев:\n\n${value}`
        )
        result = data.text
